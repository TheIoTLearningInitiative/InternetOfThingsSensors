...
Talking to our I2C devices using I2CTools is cool, and makes you look interesting, but lets face it, this is not practical enough, and option can be put everything in a shell script but we want to get further than that like writing our own module and for that  lets start creating our grown-ups c program and for that i really recommend reading the [I2C Documentation in linux](https://www.kernel.org/doc/Documentation/i2c/) (we'll be taking base code snippet from there) and about [i2c-dev library](http://lxr.free-electrons.com/source/drivers/i2c/i2c-dev.c) we will be using it to develop our C program.
...
perl-dev: unsatisfied recommendation for perl-module-pod-perldoc-getoptsoo-dev             
...
perl-dev: unsatisfied recommendation for perl-module-scalar-util-dev                       
perl-dev: unsatisfied recommendation for perl-module-io-socket-inet-dev                    
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-adapter-bunzip2-dev     
perl-dev: unsatisfied recommendation for perl-module-pod-simple-methody-dev                
perl-dev: unsatisfied recommendation for perl-module-io-file-dev                           
perl-dev: unsatisfied recommendation for perl-module-extutils-embed-dev                    
perl-dev: unsatisfied recommendation for perl-module-ipc-cmd-dev                           
perl-dev: unsatisfied recommendation for perl-module-tap-harness-dev                       
perl-dev: unsatisfied recommendation for perl-module-http-tiny-dev                         
perl-dev: unsatisfied recommendation for perl-module-locale-codes-dev                      
perl-dev: unsatisfied recommendation for perl-module-extutils-constant-base-dev            
perl-dev: unsatisfied recommendation for perl-module-extutils-typemaps-dev                 
perl-dev: unsatisfied recommendation for perl-module-b-dev                                 
perl-dev: unsatisfied recommendation for perl-module-compress-zlib-dev                     
perl-dev: unsatisfied recommendation for perl-module-extutils-constant-utils-dev           
perl-dev: unsatisfied recommendation for perl-module-pod-text-color-dev                    
perl-dev: unsatisfied recommendation for perl-module-b-concise-dev                         
perl-dev: unsatisfied recommendation for perl-module-unicore-dev                           
perl-dev: unsatisfied recommendation for perl-module-file-spec-unix-dev                    
perl-dev: unsatisfied recommendation for perl-module-inc-latest-dev                        
...
perl-dev: unsatisfied recommendation for perl-module-io-compress-zlib-extra-dev            
perl-dev: unsatisfied recommendation for perl-module-locale-codes-country-codes-dev        
perl-dev: unsatisfied recommendation for perl-module-file-basename-dev                     
perl-dev: unsatisfied recommendation for perl-module-b-deparse-dev                         
perl-dev: unsatisfied recommendation for perl-module-cwd-dev                               
perl-dev: unsatisfied recommendation for perl-module-extutils-typemaps-outputmap-dev       
perl-dev: unsatisfied recommendation for perl-module-extutils-parsexs-constants-dev        
perl-dev: unsatisfied recommendation for perl-module-bytes-dev                             
perl-dev: unsatisfied recommendation for perl-module-pod-simple-pullparserendtoken-dev     
perl-dev: unsatisfied recommendation for perl-module-net-ftp-i-dev                         
perl-dev: unsatisfied recommendation for perl-module-locale-codes-langext-codes-dev        
perl-dev: unsatisfied recommendation for perl-module-tap-parser-iterator-array-dev         
perl-dev: unsatisfied recommendation for perl-module-extutils-mm-dev                       
perl-dev: unsatisfied recommendation for perl-module-extutils-manifest-dev                 
perl-dev: unsatisfied recommendation for perl-module-extutils-mm-any-dev                   
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-rawinflate-dev          
perl-dev: unsatisfied recommendation for perl-module-load-dev                              
perl-dev: unsatisfied recommendation for perl-module-io-compress-rawdeflate-dev            
perl-dev: unsatisfied recommendation for perl-module-locale-codes-currency-codes-dev       
perl-dev: unsatisfied recommendation for perl-module-io-seekable-dev                       
perl-dev: unsatisfied recommendation for perl-module-digest-md5-dev                        
perl-dev: unsatisfied recommendation for perl-module-io-pipe-dev                           
perl-dev: unsatisfied recommendation for perl-module-time-seconds-dev                      
...
perl-dev: unsatisfied recommendation for perl-module-tie-refhash-dev                       
perl-dev: unsatisfied recommendation for perl-module-encode-config-dev                     
perl-dev: unsatisfied recommendation for perl-module-test-harness-dev                      
perl-dev: unsatisfied recommendation for perl-module-carp-dev                              
perl-dev: unsatisfied recommendation for perl-module-archive-tar-constant-dev              
perl-dev: unsatisfied recommendation for perl-lib-dev                                      
perl-dev: unsatisfied recommendation for perl-module-hash-util-fieldhash-dev               
perl-dev: unsatisfied recommendation for perl-module-attributes-dev                        
perl-dev: unsatisfied recommendation for perl-module-filter-util-call-dev                  
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-inflate-dev             
perl-dev: unsatisfied recommendation for perl-module-feature-dev                           
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-plan-dev            
perl-dev: unsatisfied recommendation for perl-module-test-builder-dev                      
perl-dev: unsatisfied recommendation for perl-module-io-dev                                
perl-dev: unsatisfied recommendation for perl-module-text-balanced-dev                     
perl-dev: unsatisfied recommendation for perl-module-net-ftp-a-dev                         
...
perl-dev: unsatisfied recommendation for perl-module-locale-codes-langfam-codes-dev        
perl-dev: unsatisfied recommendation for perl-module-autosplit-dev                         
...
perl-dev: unsatisfied recommendation for perl-module-locale-maketext-simple-dev            
perl-dev: unsatisfied recommendation for perl-module-encode-cjkconstants-dev               
perl-dev: unsatisfied recommendation for perl-module-extutils-parsexs-eval-dev             
perl-dev: unsatisfied recommendation for perl-module-ipc-open3-dev                         
perl-dev: unsatisfied recommendation for perl-module-app-prove-state-result-dev            
perl-dev: unsatisfied recommendation for perl-module-archive-tar-file-dev                  
perl-dev: unsatisfied recommendation for perl-module-file-glob-dev                         
perl-dev: unsatisfied recommendation for perl-module-file-temp-dev                         
perl-dev: unsatisfied recommendation for perl-module-i18n-langtags-dev                     
perl-dev: unsatisfied recommendation for perl-module-io-compress-adapter-deflate-dev       
perl-dev: unsatisfied recommendation for perl-module-i18n-langinfo-dev                     
perl-dev: unsatisfied recommendation for perl-module-locale-codes-langext-retired-dev      
...
perl-dev: unsatisfied recommendation for perl-module-file-globmapper-dev                   
perl-dev: unsatisfied recommendation for perl-module-symbol-dev                            
perl-dev: unsatisfied recommendation for perl-module-pod-simple-pullparsertexttoken-dev    
perl-dev: unsatisfied recommendation for perl-module-class-struct-dev                      
perl-dev: unsatisfied recommendation for perl-module-version-dev                           
perl-dev: unsatisfied recommendation for perl-module-sys-hostname-dev                      
perl-dev: unsatisfied recommendation for perl-module-encode-encoding-dev                   
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-base-dev                
perl-dev: unsatisfied recommendation for perl-module-app-prove-state-result-test-dev       
perl-dev: unsatisfied recommendation for perl-module-tap-parser-sourcehandler-executable-dv
perl-dev: unsatisfied recommendation for perl-module-autodie-hints-dev                     
perl-dev: unsatisfied recommendation for perl-module-time-hires-dev                        
perl-dev: unsatisfied recommendation for perl-module-socket-dev                            
perl-dev: unsatisfied recommendation for perl-module-tap-parser-iteratorfactory-dev        
perl-dev: unsatisfied recommendation for perl-module-inc-latest-private-dev                
perl-dev: unsatisfied recommendation for perl-module-storable-dev                          
perl-dev: unsatisfied recommendation for perl-module-pod-simple-blackbox-dev               
perl-dev: unsatisfied recommendation for perl-module-unicode-collate-dev                   
perl-dev: unsatisfied recommendation for perl-module-opcode-dev                            
perl-dev: unsatisfied recommendation for perl-module-bigint-dev                            
perl-dev: unsatisfied recommendation for perl-module-sdbm-file-dev                         
perl-dev: unsatisfied recommendation for perl-module-compress-raw-bzip2-dev                
...
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-yaml-dev            
perl-dev: unsatisfied recommendation for perl-module-mime-quotedprint-dev                  
perl-dev: unsatisfied recommendation for perl-module-net-netrc-dev                         
perl-dev: unsatisfied recommendation for perl-module-file-compare-dev                      
perl-dev: unsatisfied recommendation for perl-module-test-builder-module-dev               
perl-dev: unsatisfied recommendation for perl-module-io-compress-gzip-constants-dev        
perl-dev: unsatisfied recommendation for perl-module-tap-parser-scheduler-job-dev          
perl-dev: unsatisfied recommendation for perl-module-extutils-mm-unix-dev                  
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-unzip-dev               
perl-dev: unsatisfied recommendation for perl-module-digest-base-dev                       
...
perl-dev: unsatisfied recommendation for perl-module-encode-mime-name-dev                  
perl-dev: unsatisfied recommendation for perl-module-extutils-mkbootstrap-dev              
perl-dev: unsatisfied recommendation for perl-module-tap-formatter-file-session-dev        
perl-dev: unsatisfied recommendation for perl-module-test-builder-tester-dev               
perl-dev: unsatisfied recommendation for perl-module-user-pwent-dev                        
perl-dev: unsatisfied recommendation for perl-module-tap-parser-aggregator-dev             
...
perl-dev: unsatisfied recommendation for perl-module-threads-dev                           
perl-dev: unsatisfied recommendation for perl-module-tap-parser-sourcehandler-file-dev     
perl-dev: unsatisfied recommendation for perl-module-extutils-liblist-dev                  
perl-dev: unsatisfied recommendation for perl-module-io-compress-gzip-dev                  
perl-dev: unsatisfied recommendation for perl-module-threads-shared-dev                    
perl-dev: unsatisfied recommendation for perl-module-pod-simple-linksection-dev            
perl-dev: unsatisfied recommendation for perl-module-safe-dev                              
perl-dev: unsatisfied recommendation for perl-module-corelist-dev                          
perl-dev: unsatisfied recommendation for perl-module-universal-dev                         
perl-dev: unsatisfied recommendation for perl-module-vars-dev                              
perl-dev: unsatisfied recommendation for perl-module-io-compress-adapter-bzip2-dev         
perl-dev: unsatisfied recommendation for perl-module-carp-heavy-dev                        
perl-dev: unsatisfied recommendation for perl-module-pod-simple-tiedoutfh-dev              
perl-dev: unsatisfied recommendation for perl-module-bytes-heavy-dev                       
perl-dev: unsatisfied recommendation for perl-module-tap-parser-resultfactory-dev          
perl-dev: unsatisfied recommendation for perl-module-getopt-long-dev                       
perl-dev: unsatisfied recommendation for perl-module-pod-text-termcap-dev                  
perl-dev: unsatisfied recommendation for perl-module-app-prove-state-dev                   
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-test-dev            
perl-dev: unsatisfied recommendation for perl-module--charnames-dev                        
...
perl-dev: unsatisfied recommendation for perl-module-tap-parser-yamlish-writer-dev         
perl-dev: unsatisfied recommendation for perl-module-tie-hash-dev                          
perl-dev: unsatisfied recommendation for perl-module-tie-handle-dev                        
perl-dev: unsatisfied recommendation for perl-module-locale-codes-constants-dev            
...
perl-dev: unsatisfied recommendation for perl-module-net-ping-dev                          
perl-dev: unsatisfied recommendation for perl-module-warnings-register-dev                 
perl-dev: unsatisfied recommendation for perl-module-extutils-cbuilder-platform-unix-dev   
perl-dev: unsatisfied recommendation for perl-module-term-cap-dev                          
perl-dev: unsatisfied recommendation for perl-module-tap-object-dev                        
perl-dev: unsatisfied recommendation for perl-module-pod-simple-pullparser-dev             
perl-dev: unsatisfied recommendation for perl-module-locale-codes-langvar-codes-dev        
perl-dev: unsatisfied recommendation for perl-module-math-bigint-dev                       
perl-dev: unsatisfied recommendation for perl-module-i18n-langtags-detect-dev              
perl-dev: unsatisfied recommendation for perl-module-extutils-typemaps-inputmap-dev        
perl-dev: unsatisfied recommendation for perl-module-archive-tar-dev                       
perl-dev: unsatisfied recommendation for perl-module-tap-parser-source-dev                 
perl-dev: unsatisfied recommendation for perl-module-extutils-cbuilder-base-dev            
perl-dev: unsatisfied recommendation for perl-module-file-path-dev                         
perl-dev: unsatisfied recommendation for perl-module-io-compress-zip-constants-dev         
perl-dev: unsatisfied recommendation for perl-module-compress-raw-zlib-dev                 
perl-dev: unsatisfied recommendation for perl-module-extutils-makemaker-config-dev         
perl-dev: unsatisfied recommendation for perl-module-tap-formatter-color-dev               
...
perl-dev: unsatisfied recommendation for perl-module-extutils-typemaps-type-dev            
...
perl-dev: unsatisfied recommendation for perl-module-extutils-cbuilder-dev                 
perl-dev: unsatisfied recommendation for perl-module-tie-stdhandle-dev                     
perl-dev: unsatisfied recommendation for perl-module-io-zlib-dev                           
perl-dev: unsatisfied recommendation for perl-module-locale-maketext-dev                   
perl-dev: unsatisfied recommendation for perl-module-cpan-dev                              
perl-dev: unsatisfied recommendation for perl-module-data-dumper-dev                       
perl-dev: unsatisfied recommendation for perl-module-cgi-util-dev                          
perl-dev: unsatisfied recommendation for perl-module-if-dev                                
perl-dev: unsatisfied recommendation for perl-module-json-pp-dev                           
perl-dev: unsatisfied recommendation for perl-module-tap-parser-iterator-process-dev       
perl-dev: unsatisfied recommendation for perl-module-config-git-dev                        
perl-dev: unsatisfied recommendation for perl-module-pod-simple-dev                        
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-adapter-inflate-dev     
perl-dev: unsatisfied recommendation for perl-module-parse-cpan-meta-dev                   
perl-dev: unsatisfied recommendation for perl-module-tap-parser-sourcehandler-rawtap-dev   
perl-dev: unsatisfied recommendation for perl-module-tap-parser-grammar-dev                
...
perl-dev: unsatisfied recommendation for perl-module-pod-simple-transcode-dev              
perl-dev: unsatisfied recommendation for perl-module-extutils-installed-dev                
perl-dev: unsatisfied recommendation for perl-module-locale-codes-country-retired-dev      
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-bailout-dev         
perl-dev: unsatisfied recommendation for perl-module-tap-parser-sourcehandler-perl-dev     
perl-dev: unsatisfied recommendation for perl-module-locale-codes-script-codes-dev         
perl-dev: unsatisfied recommendation for perl-module-strict-dev                            
perl-dev: unsatisfied recommendation for perl-module-io-compress-bzip2-dev                 
perl-dev: unsatisfied recommendation for perl-module-locale-codes-langvar-retired-dev      
...
perl-dev: unsatisfied recommendation for perl-module-extutils-parsexs-dev                  
perl-dev: unsatisfied recommendation for perl-module-hash-util-dev                         
perl-dev: unsatisfied recommendation for perl-module-tap-parser-sourcehandler-handle-dev   
...
perl-dev: unsatisfied recommendation for perl-module-pod-simple-pullparsertoken-dev        
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-unknown-dev         
perl-dev: unsatisfied recommendation for perl-module-term-readline-dev                     
perl-dev: unsatisfied recommendation for perl-module-fatal-dev                             
perl-dev: unsatisfied recommendation for perl-module-mro-dev                               
perl-dev: unsatisfied recommendation for perl-module-net-ftp-dev                           
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-dev                 
perl-dev: unsatisfied recommendation for perl-module-charnames-dev                         
perl-dev: unsatisfied recommendation for perl-module-posix-dev                             
perl-dev: unsatisfied recommendation for perl-module-io-compress-base-dev                  
perl-dev: unsatisfied recommendation for perl-module-extutils-my-dev                       
perl-dev: unsatisfied recommendation for perl-module-extutils-mksymlists-dev               
perl-dev: unsatisfied recommendation for perl-module-filehandle-dev                        
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-gunzip-dev              
perl-dev: unsatisfied recommendation for perl-module-math-complex-dev                      
perl-dev: unsatisfied recommendation for perl-module-locale-codes-script-retired-dev       
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-version-dev         
perl-dev: unsatisfied recommendation for perl-module-extutils-install-dev                  
...
perl-dev: unsatisfied recommendation for perl-module-utf8-heavy-dev                        
perl-dev: unsatisfied recommendation for perl-module-encode-jp-h2z-dev                     
perl-dev: unsatisfied recommendation for perl-module-tap-parser-scheduler-spinner-dev      
perl-dev: unsatisfied recommendation for perl-module-digest-sha-dev                        
perl-dev: unsatisfied recommendation for perl-module-list-util-dev                         
perl-dev: unsatisfied recommendation for perl-module-locale-codes-language-codes-dev       
perl-dev: unsatisfied recommendation for perl-module-build-dev                             
perl-dev: unsatisfied recommendation for perl-module-autodie-exception-system-dev          
perl-dev: unsatisfied recommendation for perl-module-io-uncompress-adapter-identity-dev    
perl-dev: unsatisfied recommendation for perl-module-extutils-parsexs-countlines-dev       
perl-dev: unsatisfied recommendation for perl-module-extutils-command-dev                  
perl-dev: unsatisfied recommendation for perl-module-re-dev                                
perl-dev: unsatisfied recommendation for perl-module-io-compress-base-common-dev           
perl-dev: unsatisfied recommendation for perl-module-params-check-dev                      
perl-dev: unsatisfied recommendation for perl-module-exporter-heavy-dev                    
perl-dev: unsatisfied recommendation for perl-module-extutils-constant-proxysubs-dev       
perl-dev: unsatisfied recommendation for perl-module-io-compress-adapter-identity-dev      
perl-dev: unsatisfied recommendation for perl-module-dynaloader-dev                        
perl-dev: unsatisfied recommendation for perl-module-cgi-cookie-dev                        
perl-dev: unsatisfied recommendation for perl-module-pod-simple-pullparserstarttoken-dev   
perl-dev: unsatisfied recommendation for perl-module-math-bigrat-dev                       
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-pragma-dev          
perl-dev: unsatisfied recommendation for perl-module-test-more-dev                         
perl-dev: unsatisfied recommendation for perl-module-tap-parser-result-comment-dev         
perl-dev: unsatisfied recommendation for perl-module-overload-numbers-dev                  
perl-dev: unsatisfied recommendation for perl-module-encode-unicode-dev                    
perl-dev: unsatisfied recommendation for perl-module-tap-parser-iterator-stream-dev        
perl-dev: unsatisfied recommendation for perl-module-overloading-dev                       
...
perl-dev: unsatisfied recommendation for perl-module-io-compress-zlib-constants-dev        
perl-dev: unsatisfied recommendation for perl-module-math-bigint-trace-dev                 
perl-dev: unsatisfied recommendation for perl-module-encode-configlocal-pm-dev             
perl-dev: unsatisfied recommendation for perl-module-tap-parser-yamlish-reader-dev         
perl-dev: unsatisfied recommendation for perl-module-math-bigfloat-trace-dev               
perl-dev: unsatisfied recommendation for perl-module-file-find-dev                         
perl-dev: unsatisfied recommendation for perl-module-extutils-parsexs-utilities-dev        
perl-dev: unsatisfied recommendation for perl-module-file-spec-functions-dev               
perl-dev: unsatisfied recommendation for perl-module-pod-perldoc-topod-dev                 
perl-dev: unsatisfied recommendation for perl-module-locale-codes-langfam-retired-dev      
perl-dev: unsatisfied recommendation for perl-module-pod-text-dev                          
perl-dev: unsatisfied recommendation for perl-module-version-regex-dev                     
perl-dev: unsatisfied recommendation for perl-module-math-bigint-calc-dev                  
perl-dev: unsatisfied recommendation for perl-module-encoding-dev                          
perl-dev: unsatisfied recommendation for perl-module-text-tabs-dev                         
perl-dev: unsatisfied recommendation for perl-module-parent-dev                            
perl-dev: unsatisfied recommendation for perl-module-perlio-dev                            
perl-dev: unsatisfied recommendation for perl-module-pod-usage-dev                         
perl-dev: unsatisfied recommendation for perl-module-pod-escapes-dev                       
...
perl-dev: unsatisfied recommendation for perl-module-locale-codes-language-retired-dev     
...
perl-dev: unsatisfied recommendation for perl-module-locale-codes-currency-retired-dev     
perl-dev: unsatisfied recommendation for perl-module-file-spec-dev                         
perl-dev: unsatisfied recommendation for perl-module-tap-parser-iterator-dev               
