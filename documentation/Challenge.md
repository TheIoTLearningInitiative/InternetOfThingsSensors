...
> Look if both Linux Kernel Intel Edison and Linux Kernel Mainline versions have support for the LCD and Temperature modules and enable them, in case support is not available then 
